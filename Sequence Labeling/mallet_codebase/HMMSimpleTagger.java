...
//		if (viterbiOutputOption.value && i % 10 == 0)
		if (viterbiOutputOption.value)
			new ViterbiWriter("", new InstanceList[] {training, testing}, new String[] {"training", "testing"}).evaluate(hmmt,map,true);
    ...
    //populating the hash map
        for (int i = 0; i < trainingData.size(); i++) {
            ...
            for (int j = 0; j < input.size(); j++) {
                    map.put((String)input.get(j),true);
            }			
        }
